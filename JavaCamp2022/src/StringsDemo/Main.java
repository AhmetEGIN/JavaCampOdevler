...
public class Main {
	...
	public static void main(String[] args) {
		...
		mesaj.getChars(0, 5, characters, 2); // getChars(0(hangi karakterden baþlayacapý), 5(kaçýncý karaktere kadar
												// alacaðý, 5 i dahil etmez),
		// characters(bu char array ini nereye aktaracaðý), 2(aktarýlacak array de
		// kaçýncý karakterden baþlayacaðý))
		System.out.println(characters);
		System.out.println(mesaj.indexOf("av")); // belirttiðiniz elemanýn ilk olarak kaçýncý karakterde olduðunu
													// belirtir
		...
		String yeniMesaj = mesaj.replace(' ', '-'); // mesajý eðer farklý bir string olarak tutmak istediðimizde yeni
													// bir deðer tanýmlarýz
		...
		// split fonksiyonu string ifadeyi belli bir karakter veya karakter dizisini
		...
		String metin = "mesaj";
		String metin2 = "mesa";
		String metin3 = new String("mesaj");
		System.out.println(metin.hashCode());
		System.out.println(metin2.hashCode());
		System.out.println(metin3.hashCode());
		
		if(metin == metin3) {
			System.out.println("bu ifadeler eþit");
		}else {
			System.out.println("Eþit deðil");
		}
		if (metin.equals(metin3)) {
